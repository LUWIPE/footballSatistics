...
<div class="container mt-3 mb-5">
    <div class="row justify-content-center">
        <div class="col-11 rounded-3 border border-primary">
            <div class="row justify-content-between bg-primary rounded-3 align-items-center">
                <div class="col-9">
                    <h2 class="text-secondary m-1"> <?php echo $player->playerName ?>
        ...
        <div class="col-11 mt-3">
            <div class="row rounded-3 border border-primary justify-content-center">
                <div class="row justify-content-between bg-primary rounded-3 align-items-center">
                    <div class="col-9">
